...
public class RedisDaoImpl implements RedisDao {
    ...
    @Autowired
    RedisDaoImpl(RedisConnectionFactory redisConnectionFactory) {
...
//        redisTemplate.setValueSerializer(serializer);
    ...
    public boolean setIfAbsent(String key, Object value, long time) {
        Boolean execute = redisTemplate.execute((RedisCallback<Boolean>) redisConnection -> redisConnection.set(key.getBytes(), value.toString().getBytes(), Expiration.seconds(time), RedisStringCommands.SetOption.SET_IF_ABSENT));
    ...
    private List<String> scan(String pattern) {
        List<String> ret = redisTemplate.execute(connection -> {
